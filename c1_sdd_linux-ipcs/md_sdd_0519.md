...
| volatile const uint32_t | CPXNUM | CPU-specific logical processor number of the accessing core; read-only from Cortex-A53 or Cortex-M7. |
...
| volatile const uint32_t | CPXCFG[IPC_MSCM_CPnCFG_COUNT] | CPU-specific configuration words: CPXCFG0 L1 cache, CPXCFG1 L2 cache, CPXCFG2 TCM, CPXCFG3 processor options; read-only from Cortex-A53 or Cortex-M7. |
...
| volatile const uint32_t | CP0CFG[IPC_MSCM_CPnCFG_COUNT] | Configuration words for CP0; same four-word layout as CPXCFG0–CPXCFG3. |
...
| volatile const uint32_t | CP1CFG[IPC_MSCM_CPnCFG_COUNT] | Configuration words for CP1; same four-word layout as CPXCFG0–CPXCFG3. |
...
| volatile const uint32_t | CP2CFG[IPC_MSCM_CPnCFG_COUNT] | Configuration words for CP2; same four-word layout as CPXCFG0–CPXCFG3. |
...
| volatile const uint32_t | CP3CFG[IPC_MSCM_CPnCFG_COUNT] | Configuration words for CP3; same four-word layout as CPXCFG0–CPXCFG3. |
...
| volatile const uint32_t | CP4CFG[IPC_MSCM_CPnCFG_COUNT] | Configuration words for CP4; same four-word layout as CPXCFG0–CPXCFG3. |
...
| volatile const uint32_t | CP5CFG[IPC_MSCM_CPnCFG_COUNT] | Configuration words for CP5; same four-word layout as CPXCFG0–CPXCFG3. |
...
| volatile const uint32_t | CP6NUM | Logical processor number for CP6; same fields and function as CPXNUM. |
| volatile const uint32_t | CP6REV | Logical revision for CP6; same fields and function as CPXREV. |
| volatile const uint32_t | CP6CFG[IPC_MSCM_CPnCFG_COUNT] | Configuration words for CP6; same four-word layout as CPXCFG0–CPXCFG3. |
...
| volatile const uint32_t | CP7CFG[IPC_MSCM_CPnCFG_COUNT] | Configuration words for CP7; same four-word layout as CPXCFG0–CPXCFG3. |
...
| volatile const uint32_t | CP8CFG[IPC_MSCM_CPnCFG_COUNT] | Configuration words for CP8; same four-word layout as CPXCFG0–CPXCFG3. |
...
| volatile const uint32_t | CP9CFG[IPC_MSCM_CPnCFG_COUNT] | Configuration words for CP9; same four-word layout as CPXCFG0–CPXCFG3. |
...
| volatile uint32_t | IRCPCFG | Interrupt router configuration; designates trusted cores permitted to access and manage outstanding MSIs. |
...
| struct { volatile uint32_t IPC_ISR; volatile uint32_t IPC_IGR; } | IRCPnIRx[IPC_MSCM_CP_COUNT][IPC_MSCM_IRQ_COUNT] | Inter-core interrupt router register pairs per processor (CP0–CP11) and interrupt index (0–13): IPC_ISR maps to IRCPnISRx (interrupt status, W1C); IPC_IGR maps to IRCPnIGRx (interrupt generation). |

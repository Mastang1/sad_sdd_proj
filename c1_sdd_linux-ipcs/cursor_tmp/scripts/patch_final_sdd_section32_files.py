...
from workspace_paths import WORKSPACE_ROOT, FINAL_SDD_DOCX, IPCS_SDD_MD, SCRIPTS, CURSOR_TMP

ROOT = WORKSPACE_ROOT
FINAL_DOCX = FINAL_SDD_DOCX
SOURCE_MD = IPCS_SDD_MD
TMP_MD = CURSOR_TMP / "_patch_section32.md"
TMP_DOCX = CURSOR_TMP / "_patch_section32_generated.docx"
PATCH_HEAD = CURSOR_TMP / "_patch_head_trim.docx"
PATCH_TAIL = CURSOR_TMP / "_patch_tail_trim.docx"
WORK_COPY = CURSOR_TMP / "_patch_master_work.docx"
...
def _load_build_module():
    p = SCRIPTS / "build_final_sdd_docx.py"
...
def run_patch() -> None:
    ...
    out_tmp = Path(tempfile.mkstemp(suffix=".docx", dir=str(CURSOR_TMP))[1])
    try:

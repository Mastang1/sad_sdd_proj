...
| IPCS-OSAL | Drv_Ipcs_Osal_Cmp | OS 适配组件 | os/ipc-os.h, os/autosar, os/baremetal, os/freertos, os/threadx | 提供 shared memory 地址视图、中断接入、延迟处理上下文与 polling 桥接 |
...
| P7 | IF_PlatformOS | OS 执行环境 | Drv_Ipcs_Osal_Cmp | AutoSAR OS、Baremetal、FreeRTOS、Threadx API |
...
描述：TODO，包含CORES 组件设计 + configuration 组件。
...
![image1.png](md_sdd_0519_media/image1.png)
...
![image2.png](md_sdd_0519_media/image2.png)
...
![image3.png](md_sdd_0519_media/image3.png)
...
![image4.png](md_sdd_0519_media/image4.png)
...
![image5.png](md_sdd_0519_media/image5.png)
...
![image6.png](md_sdd_0519_media/image6.png)
...
![image7.png](md_sdd_0519_media/image7.png)
...
<tr>
<td>函数定义文件</td>
<td colspan="4">common/ipc-shm.c</td>
</tr>
<tr>
<td>函数声明文件</td>
<td colspan="4">common/ipc-shm.h</td>
</tr>
<tr>
<td>满足需求</td>
...
![image8.png](md_sdd_0519_media/image8.png)
...
![image9.png](md_sdd_0519_media/image9.png)
...
![image10.png](md_sdd_0519_media/image10.png)
...
![image11.png](md_sdd_0519_media/image11.png)
...
![image12.png](md_sdd_0519_media/image12.png)
...
![image13.png](md_sdd_0519_media/image13.png)
...
![image14.png](md_sdd_0519_media/image14.png)
...
![image15.png](md_sdd_0519_media/image15.png)
...
![image16.png](md_sdd_0519_media/image16.png)
...
<tr>
<td>函数定义文件</td>
<td colspan="4">common/ipc-queue.c</td>
</tr>
<tr>
<td>函数声明文件</td>
<td colspan="4">common/ipc-queue.h</td>
</tr>
</tbody>
</table>
...
![image17.png](md_sdd_0519_media/image17.png)
...
![image18.png](md_sdd_0519_media/image18.png)
...
![image19.png](md_sdd_0519_media/image19.png)
...
![image20.png](md_sdd_0519_media/image20.png)
...
![image21.png](md_sdd_0519_media/image21.png)
...
![image22.png](md_sdd_0519_media/image22.png)
...
![image23.png](md_sdd_0519_media/image23.png)
...
![image24.png](md_sdd_0519_media/image24.png)
...
![image25.png](md_sdd_0519_media/image25.png)
...
![image26.png](md_sdd_0519_media/image26.png)
...
![image27.png](md_sdd_0519_media/image27.png)
...
![image28.png](md_sdd_0519_media/image28.png)
...
![image29.png](md_sdd_0519_media/image29.png)
...
![image30.png](md_sdd_0519_media/image30.png)
...
![image31.png](md_sdd_0519_media/image31.png)
...
![image32.png](md_sdd_0519_media/image32.png)
...
![image33.png](md_sdd_0519_media/image33.png)
...
![image34.png](md_sdd_0519_media/image34.png)
...
![image35.png](md_sdd_0519_media/image35.png)
...
![image36.png](md_sdd_0519_media/image36.png)
...
![image37.png](md_sdd_0519_media/image37.png)
...
![image38.png](md_sdd_0519_media/image38.png)
...
<tr>
<td>函数定义文件</td>
<td colspan="4">common/ipc-util.c</td>
</tr>
<tr>
<td>函数声明文件</td>
<td colspan="4">common/ipc-util.h</td>
</tr>
</tbody>
</table>
...
![image39.png](md_sdd_0519_media/image39.png)
...
| ipc_os_priv | static struct IPCS_OS_PRIV_TYPE_TYPE | os/threadx/ipc-os-threadx.c | Threadx OS specific private data | 源码未显式指定 |
| softirq_stack | K_THREAD_STACK_DEFINE(softirq_stack, IPC_SOFTIRQ_STACK_SIZE) | os/threadx/ipc-os-threadx.c | Threadx deferred interrupt handler stack | 源码未显式指定 |
...
TODO：阐述与架构设计的动态流程设计一致，根据实际分析，补充必要的内部具体实现；根据具体单个function的实现进行具体的确定。

# 3.2.9 ipc-hw-platform.h

描述：TODO，说明基本架构设计模式及包含的RTOS种类，OS 适配层的说明；
...
| Drv_Ipcs_Osal_Cmp / ThreadX 变体 | os/threadx/ipc-os-threadx.c |
...
![image40.png](md_sdd_0519_media/image40.png)
...
![image41.png](md_sdd_0519_media/image41.png)
...
![image42.png](md_sdd_0519_media/image42.png)
...
![image43.png](md_sdd_0519_media/image43.png)
...
![image44.png](md_sdd_0519_media/image44.png)
...
![image45.png](md_sdd_0519_media/image45.png)
...
![image46.png](md_sdd_0519_media/image46.png)

### ipc-os- threadx.c

描述：

> os/threadx/ipc-os-threadx.c 属于 Drv_Ipcs_Osal_Cmp / Threadx 变体。

依赖关系：

ipc-shm.h, ipc-os.h, ipc-hw.h, <threadx/sys/mem_manage.h>, <threadx/kernel.h>, <threadx/device.h>；当定义 S32ZE 时另含 Mru_Ip.h（见 os/threadx/ipc-os-threadx.c 条件编译）

![image47.png](md_sdd_0519_media/image47.png)
...
![image48.png](md_sdd_0519_media/image48.png)
...
![image49.png](md_sdd_0519_media/image49.png)
...
![image50.png](md_sdd_0519_media/image50.png)
...
![image51.png](md_sdd_0519_media/image51.png)
...
![image52.png](md_sdd_0519_media/image52.png)
...
![image53.png](md_sdd_0519_media/image53.png)
...
![image54.png](md_sdd_0519_media/image54.png)
...
![image55.png](md_sdd_0519_media/image55.png)
...
![image56.png](md_sdd_0519_media/image56.png)
...
![image57.png](md_sdd_0519_media/image57.png)
...
![image58.png](md_sdd_0519_media/image58.png)
...
![image59.png](md_sdd_0519_media/image59.png)
...
![image60.png](md_sdd_0519_media/image60.png)
...
![image61.png](md_sdd_0519_media/image61.png)
...
![image62.png](md_sdd_0519_media/image62.png)
...
![image63.png](md_sdd_0519_media/image63.png)
...
![image64.png](md_sdd_0519_media/image64.png)
...
<tr>
<td>函数定义文件</td>
<td colspan="4">os/autosar/ipc-os-autosar.c</td>
</tr>
<tr>
<td>函数声明文件</td>
<td colspan="4">os/ipc-os.h</td>
</tr>
</tbody>
</table>
...
![image65.png](md_sdd_0519_media/image65.png)
...
![image66.png](md_sdd_0519_media/image66.png)
...
![image67.png](md_sdd_0519_media/image67.png)
...
![image68.png](md_sdd_0519_media/image68.png)
...
![image69.png](md_sdd_0519_media/image69.png)
...
![image70.png](md_sdd_0519_media/image70.png)
...
![image71.png](md_sdd_0519_media/image71.png)
...
![image72.png](md_sdd_0519_media/image72.png)
...
<tr>
<td>函数定义文件</td>
<td colspan="4">os/freertos/ipc-os-freertos.c</td>
</tr>
<tr>
<td>函数声明文件</td>
<td colspan="4">os/ipc-os.h</td>
...
![image73.png](md_sdd_0519_media/image73.png)
...
![image74.png](md_sdd_0519_media/image74.png)
...
![image75.png](md_sdd_0519_media/image75.png)
...
![image76.png](md_sdd_0519_media/image76.png)
...
![image77.png](md_sdd_0519_media/image77.png)
...
![image78.png](md_sdd_0519_media/image78.png)
...
![image79.png](md_sdd_0519_media/image79.png)
...
![image80.png](md_sdd_0519_media/image80.png)
...
<tr>
<td>函数定义文件</td>
<td colspan="4">os/threadx/ipc-os-threadx.c</td>
</tr>
<tr>
<td>函数声明文件</td>
<td colspan="4">os/ipc-os.h</td>
...
![image86.png](md_sdd_0519_media/image86.png)
